...
namespace directx {
	...
	public:
		dx_overlay( ) { }
		dx_overlay( std::string target_class, std::string target_window, bool not_topmost = false );
		~dx_overlay( );
	...
	private:
		void create_overlay( std::string target_class, std::string target_window );
		void init_dx9( );
